...
\newcommand*{\getTitle}{Distributed Execution of Unikernel Applications on Container Orchestration Platform Kubernetes for IoT Scenarios}
\newcommand*{\getTitleGer}{Verteilte Ausführung von Unikernel-Anwendungen auf OrchestierungPlatform Kubernetes für IoT Szenarien}
\newcommand*{\getAuthor}{Atakan Yenel}
\newcommand*{\getDoctype}{Master's Thesis in Informatics}
\newcommand*{\getSupervisor}{Prof. Dr. Michael Gerndt}
\newcommand*{\getAdvisor}{Vladimir Podolskiy}
\newcommand*{\getSubmissionDate}{15.01.2020}
\newcommand*{\getSubmissionLocation}{Munich}
\DeclareCaptionType{code}[Code Listing][List of Code Snippets]
\begin{document}
