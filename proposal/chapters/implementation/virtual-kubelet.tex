...
While testing for this thesis, edge devices were simulated on different virtual machines. As It's impossible to test 100+ edge devices on the wild, nodes named Rpi-\{random-id\} were generated with different labels according to their simulated tasks.
