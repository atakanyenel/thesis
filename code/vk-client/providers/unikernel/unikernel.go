...
func (*Provider) DeletePod(ctx context.Context, pod *v1.Pod) error {
	panic("Delete pod")
}
...
func (s *Provider) NodeAddresses(ctx context.Context) []v1.NodeAddress {
...
func (s *Provider) NodeDaemonEndpoints(ctx context.Context) *v1.NodeDaemonEndpoints {
...
func (s *Provider) OperatingSystem() string {
